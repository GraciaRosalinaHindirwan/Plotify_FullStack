...
<img src="/img/test.jpg" alt="building" class="w-full rounded-[16px] mb-[16px]">
<h1 class="text-[var(--color-text)] mb-[16px] font-[var(--fw-bold)] text-[18px]">Modern Boarding House</h1>
<p class="line-clamp2 text-[var(--color-text)] mb-[16px] text-[14px] ">Boarding house modern siap huni dengan konsep kekinian dan fasilitas premium.</p>
