...
<img src="{{ $property->property_image->first()->url }}" alt="building" class="w-full rounded-[16px] mb-[16px]">
<h1 class="text-[var(--color-text)] mb-[16px] font-[var(--fw-bold)] text-[18px]">{{ $property->name }}</h1>
<p class="line-clamp2 text-[var(--color-text)] mb-[16px] text-[14px] ">{{ $property->description }}</p>
